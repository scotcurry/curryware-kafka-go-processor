...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/confluentinc/confluent-kafka-go/kafka/v2 v2.0.0-rc.1 // indirect
	github.com/DataDog/dd-trace-go/v2 v2.0.0-rc.1 // indirect

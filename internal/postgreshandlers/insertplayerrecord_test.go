...
func TestInsertPlayerRecord(t *testing.T) {
	...
	InsertPlayerRecord(playerRecord.PlayerID, playerRecord.PlayerSeasonId, playerRecord.PlayerName, playerRecord.PlayerPosition, playerRecord.PlayerTeam, playerRecord.PlayerUrl, playerRecord.PlayerHeadshot)
